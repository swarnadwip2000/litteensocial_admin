                                ...
                                <div class="card" style="box-shadow: 0px 1px 10px 1px rgba(0, 0, 0, 0.15); border-radius: 13px;">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <a href="/addusermanagement" style="float:right;" class="btn btn-danger waves-effect waves-light" data-animation="fadein"  data-overlaycolor="#38414a"><i class="mdi mdi-plus-circle mr-1"></i> Add Application User</a>
                                                </div>
                                            </div><!-- end col-->
                                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->mobile}}    </td>
                                           ...
                                           <td> <input type="checkbox" data-plugin="switchery" data-color="#3db9dc" data-size="small" name="status" id="status" value="0" <?php if (!empty($data)) {
  if ($data->status == '0') {
  echo 'checked';
  }
  } ?>/>
                                        ...
                                        <td><a href="view_usermanagement?pid={{ $data->id }}" class="action-icon"><i style="font-size: 18px;" class="fa fa-eye" aria-hidden="true"></i></a>
                                                            <a href="update_usermanagement?pid={{ $data->id }}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                            <a href="delete_usermanagement/{{ $data->id }}" class="action-icon" onclick="return confirm('Are you sure you want to delete?')"> <i class="mdi mdi-delete"></i></a>
                                                        </td>
                                          </tr>
                                    @endforeach
                                                </tbody>
        ...
        <div id="custom-modal" class="modal-demo longEnough">
            ...
            <form method="post" action="/saveusermanagement" class="form-horizontal">
                    @csrf
