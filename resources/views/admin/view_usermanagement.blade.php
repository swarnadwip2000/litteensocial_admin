                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">List View Application Management</a></li>
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">View Application Management</a></li>
                                           
                                        </ol>
                                    </div>
                                    <h4 class="page-title">View Application Management</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
...
echo $data->email;
                        ...
                        <img  class="form-control" src="{{ url($data->profile_picture) }}" style="width: 85px; height: calc(2.25rem + 2px);"><br/>

<label for="image">Choose Interests</label>
<select  placeholder="Select Interests" data-search="false" class="form-control" name="interest" id="interest" data-toggle="1select2" data-select2-id="1" tabindex="-1" aria-hidden="true" disabled>
...
@else
	 <img  class="form-control" src="" style="width: 85px; height: calc(2.25rem + 2px);" alt=""> <br/>             

@endif
                        <label for="image">Choose School</label>
<select disabled placeholder="Select School" data-search="false" class="form-control" name="school" id="school" data-toggle="select2" data-select2-id="1" tabindex="-1" aria-hidden="true">
...
echo $data->username;
    ...
    <label for="name">Birthdate <span class="star">*</span></label><br/>
    <input type="text" class="form-control" name="username" id="username" placeholder="Enter User Name" value="<?php            
...
<select disabled placeholder="Select Country"  class="form-control" name="country" id="country" data-search="false" data-toggle="select2" data-select2-id="1" tabindex="-1" aria-hidden="true">
...
<select disabled placeholder="Select Status" class="form-control" name="status" >
