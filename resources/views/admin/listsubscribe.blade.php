                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Subscribe Management</a></li>
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">List Subscribe Management</a></li>
                                           
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Subscribe Management</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                            ...
                            <div class="col-12">
                                <div class="card" style="box-shadow: 0px 1px 10px 1px rgba(0, 0, 0, 0.15); border-radius: 13px;">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <a href="/addsubscribe" style="float:right;" class="btn btn-danger waves-effect waves-light" data-animation="fadein"  data-overlaycolor="#38414a"><i class="mdi mdi-plus-circle mr-1"></i> Add Subscription</a>
                                                </div>
                                            </div><!-- end col-->
                                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->subscribe_title}}     </td>
                                        <td>{{ $data->days}}    </td>                                       
                                        <td>{{ $data->subscribe_price}}    </td>
                                 
                                      
                                        <td>
                                                            <a href="updatesubscribe?pid={{ $data->id }}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                            <a href="deletesubscribe/{{ $data->id }}" class="action-icon" onclick="return confirm('Are you sure you want to delete?')"> <i class="mdi mdi-delete"></i></a>
                                                        </td>
                                          </tr>
                                    @endforeach
                                                </tbody>
