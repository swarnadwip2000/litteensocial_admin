                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Template 1
                                    </a></li>

                            </ol>
                        </div>
                        <h4 class="page-title">Email Template 1</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-8">
                                    <div class="text-sm-right">
                                        <a href="{{ route('send-promotionl-email', ['type' => 1]) }}"
                                ...
                                <html lang="en-US">
                                   ...
                                   <body>
                                      <section class="wrapper">
                                         <div class="container">
                                            <h1>Aren't You curious who is on <br><strong>Lit Teen Social? 😍</strong></h1>
                                            <div class="img-wrp">
                                               <img src="{{URL::asset('assets/email/user-new.jpg')}}">
                                            </div>
                                            <div class="download-btn">
                                               <a href="#"><img src="{{URL::asset('assets/email/logo.png')}}"><span>download now</span></a>
                                            </div>
                                            <ul>
                                               <li>
                                            ...
                                            <h2>Lit Teen Social is giving you a FREE Membership!</h2>
                                         </div>
                                      </section>
                                   </body>
                                   </html>
