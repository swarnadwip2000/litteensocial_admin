                            ...
                            <div class="col-12">
                                <div class="card" style="box-shadow: 0px 1px 10px 1px rgba(0, 0, 0, 0.15); border-radius: 13px;">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <a href="/addadvertiser" style="float:right;" class="btn btn-danger waves-effect waves-light" data-animation="fadein"  data-overlaycolor="#38414a"><i class="mdi mdi-plus-circle mr-1"></i> Add Advertiser User</a>
                                                </div>
                                            </div><!-- end col-->
                                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="view_advertiser?pid={{ $data->id }}" class="action-icon"><i style="font-size: 18px;" class="fa fa-eye" aria-hidden="true"></i></a>
                                                            <a href="update_advertiser?pid={{ $data->id }}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                            <a href="delete_advertiser/{{ $data->id }}" class="action-icon" onclick="return confirm('Are you sure you want to delete?')"> <i class="mdi mdi-delete"></i></a>
                                                        </td>
                                          </tr>
                                    @endforeach
                                                </tbody>
