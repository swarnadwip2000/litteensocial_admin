        ...
        <li>
           ...
           <li>
            ...
            <i class="fa fa-plus" aria-hidden="true"></i>
                ...
                <span> Advertisment Plan</span>
            </a>

        </li>

              <li>
               <a href="/listadvertisements">
               <i class="fa fa-plus-circle" aria-hidden="true"></i>
            ...
            <!-- <li>
               <a href="/list_stories_time_duration">
               <i class="fe-users"></i>

                   <span> Stories Time Duration</span>
               </a>
            ...
            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="{{route('email-template-1')}}">Email Template 1</a>
                                    </li>
                                    <li>
                                        <a href="{{route('email-template-2')}}">Email Template 2</a>
                                    </li>
                                    <li>
                                        <a href="{{route('email-template-3')}}">Email Template 3</a>
                                    </li>
           ...
           <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="/listsettings">Background Image</a>
                                    </li>
                                    <li>
                                        <a href="/listinterests">Interests</a>
                                    </li>
